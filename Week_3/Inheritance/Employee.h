/* 
* The employee class will have an employee ID as well as
* a dynamic array of Person objects called "dependants".
* We will make constructors, destructors and getters/setters. 
*/
